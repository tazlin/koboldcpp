...
extern std::atomic<float> last_eval_time;
extern std::atomic<float> last_process_time;
extern std::atomic<int> last_token_count;
extern std::atomic<int> last_input_count;
extern std::atomic<int> last_seed;
extern std::atomic<int> total_gens;
extern int total_img_gens;
extern int total_tts_gens;
extern int total_transcribe_gens;
extern std::atomic<int> last_draft_success;
extern std::atomic<int> last_draft_failed;
extern std::atomic<stop_reason> last_stop_reason;
